...
<template>
	<div class="tw:relative tw:w-full">
		...
		<div
			class="tw:flex tw:flex-col tw:gap-4 tw:border tw:border-gray-300 tw:rounded tw:bg-white tw:p-4 tw:min-h-[350px] focus-within:tw:border-primary focus-within:tw:border-2">
			...
			<div class="tw:grid tw:grid-cols-[1fr_auto_1fr] tw:gap-4 tw:items-start tw:flex-1 tw:min-h-0">
				...
				<div class="tw:overflow-auto tw:space-y-0 tw:min-h-0">
					<div v-for="item in filteredAvailable" :key="item.id" @click="toggleSelectedAvailable(item.id)"
						...
						<div class="tw:text-xs tw:mt-1"
							...
							{{ item.type === "Spatial" ? "Spatial" : "Contextual" }}
						</div>
					</div>
				...
				<!-- Colonna 2: Bottoni -->
				<div class="tw:flex tw:flex-col tw:gap-2 tw:items-center tw:justify-center tw:self-center">
